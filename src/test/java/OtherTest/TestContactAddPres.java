...
public class TestContactAddPres {
    ...
    private void getJsonTest() {
        ...
        String username = "test866@tst-boxpg-minsk98.mangosip.ru";
        ...
        //String auth_token = "auth_token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJyIjoiNWRyaWEiLCJleHAiOjE2MDA5NjQyNzQsImlkbiI6IjZtNjRsdDo2bTY5bDQ6Nm02cHlmOjZuZzBnajo1ejYxejpNVC5Nb2JpbGU6c2lwOjoifQ.eFowGFQaSSrbelxc5S8W375Cia9EnCmbjLmnUzgQuWg";
        ...
        String url_contact_add = "http://abws-pres-brt-pres-ru.by.mgo.su/contacts/add";
    ...
    public String jsonContactAdd(){
        ...
        data_into.addProperty("name", "Contact BRT created");
